      ...
      <div class="container-fluid">
        ...
        <div class="card card-submenu-compact" style="border-top: 3px solid var(--theme-yellow-primary);">
            ...
            <form id="mainFilterForm" action="<?= base_url('history') ?>" method="get">
                ...
                <div class="card-body" style="height: 550px; display: flex; flex-direction: column;">
                    <div class="table-responsive" style="flex: 1; overflow: auto;">
                        <table class="table table-striped table-bordered table-hover text-nowrap table-sticky-header" style="width: 100%;">
                            <thead>
           ...
           <div class="custom-card-footer bg-white d-flex align-items-center" style="border-top: 1px solid #dee2e6;">
                ...
                <div class="d-flex align-items-center justify-content-end text-muted" style="flex: 1; font-size: 9px !important;">
                    ...
                    <div class="dropdown" style="width: 50px;"> 
                        <button class="btn btn-sm btn-white border dropdown-toggle w-100" type="button" id="limitDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size: 9px !important; height: 22px; padding: 0 5px; display: flex; align-items: center; justify-content: space-between; background: #fff;">
