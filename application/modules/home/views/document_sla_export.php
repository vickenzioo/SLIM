    ...
    <page_footer>
        ...
        <table>
            ...
            <?php
                ...
                $ci =& get_instance();
                $total_in_category = $ci->db->where('category_id', $category_id)->count_all_results('tbl_portofolio_apps_master');
                ...
                <tr>
                    ...
                    <td style="text-align: right; padding: 8px; border: 1px solid #dee2e6;">
                        <?php 
                            ...
                            // Pastikan tidak nol untuk mencegah error matematis
                            $t_day  = (!empty($app['total_day'])) ? (int)$app['total_day'] : 0;
                            $t_hour = (!empty($app['total_hour'])) ? (int)$app['total_hour'] : 0;
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="vertical-align: middle; padding: 10px 8px;">
                        ...
                        <tr>
                            <td rowspan="2" style="border: none; padding: 0 4px 0 0; vertical-align: middle; font-family: Arial, sans-serif; font-size: 10px; color: #555; width: 20px;">1 - (</td>
                            <td style="border: none; border-bottom: 0.5px solid #555; padding: 0 5px; vertical-align: bottom; text-align: center; font-family: Arial, sans-serif; font-size: 10px; color: #555; width: 110px;"><i>Unplanned Downtime</i></td>
                            <td rowspan="2" style="border: none; padding: 0 0 0 4px; vertical-align: middle; font-family: Arial, sans-serif; font-size: 10px; color: #555; text-align: left;">x 100% )</td>
                        </tr>
                        <tr>
                            <td style="border: none; padding: 2px 5px 0 5px; vertical-align: top; text-align: center; font-family: Arial, sans-serif; font-size: 10px; color: #555; width: 110px;"><i>Committed uptime</i></td>
                        </tr>
                        </table>
                    </td>
                </tr>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding: 8px;">
                        <strong><?= !empty($app['ho_name_user']) ? $app['ho_name_user'] : (isset($app['lob_department_head']) ? $app['lob_department_head'] : '-') ?></strong><br>
                        Head of <?= !empty($app['sub_dir_user']) ? $app['sub_dir_user'] : (isset($app['lob_subdirectorate']) ? $app['lob_subdirectorate'] : '-') ?>
                    </td>
                </tr>
