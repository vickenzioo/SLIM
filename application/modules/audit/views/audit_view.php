    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0" style="color: var(--text-dark); font-weight: 700; font-size: 18px;">Audit Trail</h1>
                        <p class="text-muted" style="font-size: 12px">History of changes for: <span class="font-weight-bold" style="color: #3f51b5; font-size: 12px;"><?= $target_name ?></span></p>
                    </div>
                                ...
                                <form action="<?= current_url() ?>" method="GET">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            ...
                                            <a href="<?= current_url() ?>" class="btn btn-secondary d-flex align-items-center">
                                                ...
                                                <?php 
                                                    if (!empty($l['field_name'])) {
                                                        ...
                                                        $display_names = [
                                                            ...
                                                            'start_day'       => 'Start Day',
                                                            'end_day'         => 'End Day',
                                                            'Holiday_Name'            => 'Holiday Name', // Gunakan underscore sesuai DB
                                                            'Holiday_Date'            => 'Holiday Date', // Gunakan underscore sesuai DB
