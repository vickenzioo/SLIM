...
<div class="modal fade modal-submenu-compact" id="modalCategory" tabindex="-1" role="dialog">
            ...
            <div class="form-group">
                ...
                <div class="form-text text-end" style="font-size: 0.85rem;">
                    <p style="text-align: right; font-size: 9px; color: #666; margin-top: 4px;">
                        Note: Isi '0' jika category tidak memiliki standard category.
                    </p>
                </div>
            </div>
...
<script>
    ...
    // --- 4. Fungsi Konfirmasi Hapus (Delete) dengan Input Reason ---
