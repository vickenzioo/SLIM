...
<div class="modal fade modal-submenu-compact" id="modalDatabase" tabindex="-1" role="dialog">
...
<script>
    ...
    $(document).on('input', '#database_name, #reason, input[name="keyword"], .filter-search-input, .swal2-popup input[type="text"], .swal2-popup textarea', function() {
     ...
     $(document).on('paste', '#database_name, #reason, input[name="keyword"], .filter-search-input, .swal2-popup input[type="text"], .swal2-popup textarea', function(e) {
        ...
        if (forbiddenChars.test(pasteData)) {
            // Jika mengandung karakter terlarang, gagalkan proses paste
            e.preventDefault();
