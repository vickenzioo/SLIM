  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0" style="color: var(--text-dark); font-weight: 700; font-size: 18px !important;">Application Type Management</h1>
          </div>
          <div class="col-sm-6">
...
<div class="modal fade modal-submenu-compact" id="modalAppType" tabindex="-1" role="dialog">
